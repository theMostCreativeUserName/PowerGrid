 ...
 * null und Duplikate (mehrere Exemplare des gleichen Elementes) sind erlaubt.
 * @author R. Schiedermeier, rs@cs.hm.edu
 * @version last modified 2020-03-30
 */
public interface Bag<E> extends Collection<E> {
     ...
     * Elemente enthaelt und ebenso veraenderlich oder unveraenderlich ist.
     * @param anything Eine Referenz.
     * @return true genau dann, wenn anything eine gleiche Tuete ist.
     */
    @Override
