...
public class DropResourceTest {
    ...
    @Test
    public void testDropResourceProperties() {
        // arrange
        OpenGame opengame = (OpenGame) sut.getGame();
        opengame.setPhase(Phase.PlantOperation);
        OpenFactory factory = opengame.getFactory();
        ...
        assertSame(move.getProperties().getProperty("type"), MoveType.DropResource.toString());
    ...
    public void testDropResourceFireException() {
        // arrange
        OpenGame opengame = (OpenGame) sut.getGame();
        opengame.setPhase(Phase.PlantOperation);
        OpenFactory factory = opengame.getFactory();
